#ifndef UPFNETWORKLIB_UTILS
#define UPFNETWORKLIB_UTILS
...
/// @brief Dump a NetworkLib::MACAddress in a human-readable form.
...
/// @brief Dump a NetworkLib::IPv4Address in a human-readable form.
inline std::ostream &operator<<(std::ostream &ostr,
...
class IPv4CIDR {
  public:
    ...
    /// @brief Dump a NetworkLib::IPv4CIDR in a human-readable form.
...
///        NetworkLib::IPv4Address, so it can be used as a key in
...
/// @brief A specialization of the hash function for class
///        NetworkLib::MACAddress, so it can be used as a key in
